...
public class ConstValue {
 // public  static String BASE_URL = "http://testalltime.com/education";
    public  static String BASE_URL = "http://digisoc.in/digisoc/";
    ...
    public static String NEARBY_URL = BASE_URL+"/index.php/api/get_school_nearby";
    public static String DAILY_URL = BASE_URL+"/index.php/api/get_school_daily";
