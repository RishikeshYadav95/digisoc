...
public class NearbyAdapter extends BaseAdapter {
    ...
    public NearbyAdapter(Activity act, JSONArray arraylist){
        this.context = act;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.row_nearby, null);
        }
        ...
        try {
            ...
            txtlocation.setText(jObj.getString("location"));
            txttitle.setText(jObj.getString("title"));

            ImageView top_image = (ImageView)convertView.findViewById(R.id.img);
            if(jObj.getString("image").equalsIgnoreCase("")){
                top_image.setVisibility(View.GONE);
            }else {
                ImageLoader.getInstance().displayImage(ConstValue.BASE_URL + "/uploads/nearby/" + jObj.getString("image"), top_image, options, animateFirstListener);
    ...
    class loadDataTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                String json = jParser.makeHttpRequest(ConstValue.NEARBY_URL,"POST", nameValuePairs);
