...
//                        .setAction("Action", null).show();
        ...
        menu_icon.add(R.drawable.ic_menu_02copy);
        ...
        menu_name.add(getString(R.string.menu_examandresult));
        menu_name.add(getString(R.string.menu_growth));
        menu_name.add(getString(R.string.menu_activity));
        menu_name.add(getString(R.string.menu_nearby));
        menu_name.add(getString(R.string.menu_payment));
